...
<head>
    ...
    <title>Admin - Sistem Informasi Fip2</title>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro" style="margin-top: 30px">
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a href="kategori_3.php" aria-expanded="false"><span class="educate-icon educate-course icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Data Kategori_3</span></a>
                        </li>

                        <li>
                            <a href="kategori_4.php" aria-expanded="false"><span class="educate-icon educate-course icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Data Kategori_4</span></a>
                        </li>
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="#" class="nav-link">Sistem Informasi Fip2</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="header-right-info">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <div role="menu" class="notification-author dropdown-menu">
                                                        ...
                                                        <ul class="notification-menu">
                                                            <?php 
                                                            $arsip = mysqli_query($koneksi,"SELECT * FROM tb_riwayat_download,tb_dokumen,tb_user WHERE riwayat_dokumen=id_dokumen and riwayat_user=id ORDER BY riwayat_id DESC");
                                                                    ...
                                                                    <a href="riwayat.php">
                                                                        <div class="notification-content">
                                                                           <p>
                                                                            ...
                                                                            <br>
                                                                            <b><?php echo $p['nama_user'] ?></b> mengunduh <b><?php echo $p['nama_dokumen'] ?></b>.
                                                                        </p>
                                                                    </div>
                                                                </a>
                                                                <hr>
                                            ...
                                            <li class="nav-item">
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                    ...
                                                    $profil = mysqli_query($koneksi,"select * from tb_admin where id='$id_admin'");
                                                    $profil = mysqli_fetch_assoc($profil);
                                                    if($profil['foto'] == ""){ 
                                                      ?>
                                                      <img src="../gambar/sistem/user.png" style="width: 20px;height: 20px">
                                                  <?php }else{ ?>
                                                    <img src="../gambar/admin/<?php echo $profil['foto'] ?>" style="width: 20px;height: 20px">
                                                <?php } ?>
