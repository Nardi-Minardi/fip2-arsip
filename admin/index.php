...
<div class="traffice-source-area mg-b-30">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="white-box analytics-info-cs res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
                    <h3 class="box-title">Kategori_3 Arsip</h3>
                    <ul class="list-inline two-part-sp">
                        <li>
                        ...
                        <li class="text-right graph-four-ctn">
                            ...
                            <span class="text-danger">
                                <?php 
                                $jumlah_kategori_3 = mysqli_query($koneksi,"select * from tb_kategori_3");
                                ?>
                                <span class="counter"><?php echo mysqli_num_rows($jumlah_kategori_3); ?></span>
                            </span>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="white-box analytics-info-cs">
                    <h3 class="box-title">Kategori_4 Arsip</h3>
                    <ul class="list-inline two-part-sp">
                        <li>
                        ...
                        <li class="text-right sp-cn-r">
                            ...
                            <span class="counter text-success">
                                <?php 
                                $jumlah_tb_kategori_4 = mysqli_query($koneksi,"select * from tb_kategori_4");
                                ?>
                                <span class="counter"><?php echo mysqli_num_rows($jumlah_tb_kategori_4); ?></span>
                            </span>
                        </li>
                    </ul>
                </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                ...
                $saya = mysqli_query($koneksi,"select * from tb_admin where id='$id_admin'");
                ...
                <div class="single-cards-item">
                    ...
                    <div class="single-product-text">
                        ...
                        if($s['foto'] == ""){
                            ...
                            ?>
                            <img class="img-user" src="../gambar/admin/<?php echo $s['foto']; ?>">
                            <?php
                        }
                        ?>

                        <h4><a class="cards-hd-dn" href="#"><?php echo $s['nama_admin']; ?></a></h4>
                        <h5>Admin</h5>
